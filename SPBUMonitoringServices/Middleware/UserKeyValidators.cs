...
namespace SPBUMonitoringServices.Middleware {

    public class UserKeyValidatorsMiddleware {

        private readonly RequestDelegate _next;
        private IDashboardsRepository ContactsRepo { get; set; }

        public UserKeyValidatorsMiddleware(RequestDelegate next, IDashboardsRepository _repo) {
            _next = next;
            ContactsRepo = _repo;
        }
